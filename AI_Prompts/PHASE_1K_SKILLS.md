# Phase 1K — Skills & Proficiency

> **SMAUG 2.0 Legacy Codebase Analysis — Phase 1 Sub-Phase K**
...
| File | Lines | Why |
|------|-------|-----|
| `skills.c` | 3,800 | Skill system — proficiency, learning, practice, skill execution |

---

## Specific Instructions

1. **Skill proficiency:** How `pc_data.learned[]` stores skill percentages. How
   proficiency affects success chance.
2. **Skill learning:** `do_practice()` — how skills are improved. Practice points.
   Maximum proficiency per class/level.
3. **Skill execution:** How non-spell skills are invoked and resolved. Success/failure
   determination.
4. **Skill availability:** How class and level determine which skills a character can
   learn. `skill_table[].skill_level[]` per class.
5. **Weapon proficiencies:** How weapon type proficiency works.
6. **Tongue/language skills:** How language proficiency is handled as a skill.
7. **`do_slist()`:** How the skill list is displayed to players.
8. **Skill groups:** Any grouping or categorisation of skills.
9. **Adept level:** The maximum proficiency a player can reach through practice
   (typically class-dependent).

---

## Output

- **Append** to `ANALYSIS.md` section `## 11. Skills & Proficiency`.
- **Append** to `COMMANDS.md` any skill commands found.

---

## Acceptance Criteria

- [ ] Skill proficiency system documented.
- [ ] Practice/learning mechanics documented with formulas.
- [ ] Skill availability per class/level documented.
- [ ] Weapon proficiency system documented.
- [ ] Language skill system documented.
