# Phase 1Q — Quests & Housing

> **SMAUG 2.0 Legacy Codebase Analysis — Phase 1 Sub-Phase Q**
...
| File | Lines | Why |
|------|-------|-----|
| `quest.c` | ~1,500 | Automated quest system |
| `house.c` | ~1,000 | Player housing system |
...
### Quests
1. **Quest generation:** How quests are automatically generated. What types exist
   (mob kill, object recovery, etc.).
2. **Quest assignment:** How a quest is assigned to a player. Questmaster NPC.
3. **Quest tracking:** `pc_data` fields for active quest state.
4. **Quest completion:** How completion is detected and rewards given.
5. **Rewards:** Gold, quest points, practices — exact amounts or formulas.
6. **Timers:** Quest time limits. Cooldown between quests.
7. **Quest points economy:** What quest points can buy.

### Housing
8. **House creation:** How player houses are created. Room limits.
9. **House ownership:** Key system. Access control.
10. **House accessories:** Furniture, storage.
11. **House auction:** How houses are bought and sold.
12. **Persistence:** How house data survives reboots.

---

## Output

- **Append** to `ANALYSIS.md` section `## 17. Quests & Housing`.
- **Append** to `COMMANDS.md` any quest/housing commands found.

---

## Acceptance Criteria

- [ ] Quest generation algorithm documented.
- [ ] Quest reward formulas extracted.
- [ ] Quest timer/cooldown mechanics documented.
- [ ] House creation and ownership documented.
- [ ] House auction mechanics documented.
