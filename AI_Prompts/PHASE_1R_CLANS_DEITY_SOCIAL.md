# Phase 1R — Clans, Deity & Social Systems

> **SMAUG 2.0 Legacy Codebase Analysis — Phase 1 Sub-Phase R**
...
| File | Lines | Why |
|------|-------|-----|
| `clans.c` | ~1,500 | Clan/guild/order management |
| `deity.c` | ~800 | Deity system — worship, favour, alignment |
| `marry.c` | ~300 | Marriage system |
...
### Clans
1. **Clan types:** `CLAN_PLAIN`, `CLAN_ORDER`, `CLAN_GUILD` — differences between each.
2. **Clan data structure:** `clan_data` fields — name, leader, members, treasury,
   PKills/PDeaths, etc.
3. **Membership:** Joining, ranking, leaving, expulsion mechanics.
4. **Clan treasury:** How clan funds work.
5. **Clan wars / PK:** How clan membership affects PK rules.
6. **Council system:** How councils differ from clans.

### Deity System
7. **Deity data:** What defines a deity — alignment, favoured actions, susceptibilities.
8. **Favour system:** How `pc_data.favor` is earned and lost. What actions affect favour.
9. **Deity powers:** What benefits/penalties deities grant based on favour level.
10. **Worship mechanics:** How players choose and change deities.

### Marriage
11. **Marriage mechanics:** What mechanical effects marriage has (if any beyond roleplay).
12. **Divorce:** How marriages are dissolved.

---

## Output

- **Append** to `ANALYSIS.md` section `## 18. Clans, Deity & Social Systems`.
- **Append** to `COMMANDS.md` any clan/deity/marriage commands found.

---

## Acceptance Criteria

- [ ] All clan types documented with differences.
- [ ] Clan membership lifecycle documented.
- [ ] Deity favour system documented with formulas.
- [ ] Marriage mechanics documented.
